...
namespace SolarHomeAuto.Infrastructure.DataStore.SqlServer.Migrations
{
    ...
    [Migration("20230804123908_DevicesConfig")]
    partial class DevicesConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SolarHomeAuto.Infrastructure.DataStore.Entities.SolarExcessJobEntity", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex(new[] { "JobId" }, "IX_SolarExcessJob_JobId"), false);
